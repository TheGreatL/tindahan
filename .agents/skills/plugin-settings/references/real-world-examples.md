...
Depends on Task 3.4 (user model). Report status to 'team-leader' session.
```
...
Fix all the linting errors in the project. Make sure tests pass after each fix. Document any changes needed in
CLAUDE.md.
```
